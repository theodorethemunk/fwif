        ...
        function update({
            ...
            const swiperInstance = new Swiper(
                `${selector} > .breakdance-swiper-wrapper > .swiper`, {
                    ...
                    autoplay: settings.autoplay === "enabled" && (!isBuilder || forceAutoplay) ?
                        {
                    ...
                    centeredSlides: isCoverflowEffect ? // We decided to make it always true because otherwise it looks ugly
                        true :
